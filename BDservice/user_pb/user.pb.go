...
const file_user_proto_rawDesc = "" +
	...
	"\x05items\x18\x01 \x03(\v2\x0e.user.CartItemR\x05items2\x9e\x01\n" +
	"\vUserService\x12H\n" +
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 3: user.UserService.CreateAccount:output_type -> user.CreateAccountResponse
	3, // 4: user.UserService.Avtorization:output_type -> user.AvtorizationResponse
